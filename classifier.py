...
nb_pipeline = Pipeline([
        ('NBCV',FeatureSelection.count_vectorizer),
...
logR_pipeline = Pipeline([
        ('LogRCV',FeatureSelection.count_vectorizer),
...
svm_pipeline = Pipeline([
        ('svmCV',FeatureSelection.count_vectorizer),
...
sgd_pipeline = Pipeline([
        ('svm2CV',FeatureSelection.count_vectorizer),
...
random_forest = Pipeline([
        ('rfCV',FeatureSelection.count_vectorizer),
...
svm_pipeline_ngram = Pipeline([
        ...
        ('svm_clf',svm.LinearSVC(penalty='l2', loss='squared_hinge', dual=False, C=1.0))
        ])
...
gs_clf = GridSearchCV(svm, parameters, scoring='accuracy', n_jobs=1)#yaha -1 se 1 me change kiya hai jobs ko le kar
gs_clf = GridSearchCV(random_forest_ngram, parameters, scoring='accuracy', n_jobs=1)
